...
public class GroupGlobalMuteEvent implements BotEvent {
    private final Bot bot;
    private final ConversationRef conversation;
    private final UserRef operator;
    private final Duration duration;
    private final Instant time;
    public GroupGlobalMuteEvent(Bot bot, ConversationRef conversation, UserRef operator, Duration duration, Instant time) {
        this.bot = bot;
